...
<body>
	...
	<form action="insertCommentsOK.do" method="post"
		...
		<br> <label for="user_id">USER_ID:</label> <input type="text"
			id="user_id" name="user_id" required><br>
		<br> <label for="act_id">ACT_ID:</label> <input type="text"
			id="act_id" name="act_id" required><br>
		<br> <label for="content">Content:</label><br>
		<textarea id="content" name="content" rows="5" cols="50" required></textarea>
		<br>
		<br> <label for="rate">Rate:</label> <select id="rate"
			name="rate" required>
