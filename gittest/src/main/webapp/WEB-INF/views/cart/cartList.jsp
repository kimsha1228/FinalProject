        ...
        <c:forEach items="${cartList}" var="activity">
            <div style="border: 1px solid black; padding: 10px; margin-bottom: 10px;">
                <div style="float: left;">
                    <input type="checkbox" name="selectedActivities" value="${activity.act_id}">
                </div>
                <div style="float: right;">
                    <a href="${pageContext.request.contextPath}/deleteOneCart.do?act_id=${activity.act_id}">삭제</a>
                </div>
                ...
                <div style="text-align: center;">
                    <form action="${pageContext.request.contextPath}/reserveActivity.do" method="POST">
                        <input type="hidden" name="activityId" value="${activity.act_id}">
