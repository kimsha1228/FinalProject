...
<div>
	...
	markerArray[i].setMap(null); //마커를 제거하는 함수 <a href="https://navermaps.github.io/maps.js.ncp/docs/naver.maps.Marker.html#setMap__anchor" target='_blank'> 링크 </a><br>
	polyline.getPath().removeAt(i); //i번째 인덱스를 제거하고 다시 그림 <a href="https://d2.naver.com/helloworld/3380225" target='_blank'> 링크 </a><br>
	markerArray.splice(i,1); //배열 내부에서도 없앰<br>
